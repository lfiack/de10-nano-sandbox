...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios0_ip.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x81038
SOPC_SYSID_FLAG += --sidp=0x81038
ELF_PATCH_FLAG  += --sidp 0x81038

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1702043195
SOPC_SYSID_FLAG += --timestamp=1702043195
ELF_PATCH_FLAG  += --timestamp 1702043195
