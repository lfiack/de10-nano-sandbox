...
# ACDS 22.1 917 linux 2023.12.07.08:49:33
# ----------------------------------------
...
# ----------------------------------------
# If DE10_NANO_QSYS is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "DE10_NANO_QSYS"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/DE10_NANO_QSYS.v"
}
